...
'Drita e verdhë pulsuese tregon rrezik të mundshëm. Ulni shpejtësinë.', 'easy', 3, true, true, 'Mbani këmbën pranë frenave në këto situata.', 1),
...
'Kjo kombinim paralajmëron se së shpejti do të ndizet drita e gjelbër.', 'easy', 3, true, true, 'Mos u nisni para se të ndizet drita e gjelbër.', 1),
...
'Kthimi lejohet vetëm nëse ka një shigjetë të gjelbër shtesë ose sinjalistikë që e lejon.', 'medium', 5, true, true, 'Kontrolloni gjithmonë për këmbësorë edhe nëse keni shigjetë të gjelbër.', 2),
...
'Kur semafori nuk punon, vlejnë shenjat e trafikut ose rregulli i krahut të djathtë.', 'medium', 5, true, true, 'Bëni kujdes të shtuar sepse shoferët e tjerë mund të jenë konfuzë.', 2),
...
'Drita e gjelbër pulsuese tregon se së shpejti do të ndizet drita e verdhë dhe pastaj e kuqe.', 'easy', 3, true, true, 'Mos përshpejtoni, përgatituni për ndalim.', 1);
...
'Shenja STOP detyron ndalimin e plotë të mjetit para vijës së ndalimit.', 'easy', 3, true, true, 'Ndaloni plotësisht, rrotat nuk duhet të lëvizin.', 1),
...
'Kjo shenjë tregon se duhet t''u jepni përparësi mjeteve në rrugën kryesore.', 'easy', 3, true, true, 'Shikoni majtas dhe djathtas dy herë.', 1),
...
'Shenjat rrethore me bordurë të kuqe janë shenja ndalimi ose kufizimi.', 'medium', 5, true, true, 'Mos i injoroni kurrë këto shenja, janë urdhëruese.', 2),
...
'Shenjat katrore ose drejtkëndëshe me ngjyrë blu japin informacione ose tregojnë shërbime.', 'easy', 3, true, true, 'Përdorini për të gjetur spitale, parkingje ose dalje.', 1),
...
'Shenjat e rrezikut janë zakonisht trekëndore me kulm lart dhe bordurë të kuqe.', 'medium', 5, true, true, 'Ulni shpejtësinë para se të hyni në kthesë.', 2);
...
'Këmbësorët kanë përparësi absolute në vijat e bardha.', 'easy', 3, true, true, 'Krijoni kontakt me sy me këmbësorin.', 1),
...
'Parakalimi në afërsi të vendkalimeve të këmbësorëve është i rrezikshëm dhe i ndaluar.', 'hard', 8, true, true, 'Mund të mos shihni dikë që po kalon para mjetit që parakaloni.', 3),
...
'Fëmijët janë të paparashikueshëm. Ulni shpejtësinë dhe jini gati për frenim.', 'medium', 5, true, true, 'Hiqni këmbën nga gazi menjëherë.', 2),
...
'Edhe pse nuk kanë përparësi, duhet të shmangni aksidentin me çdo kusht.', 'medium', 5, true, true, 'Jeta ka përparësi mbi rregullat.', 2),
...
'Tregoni durim dhe kujdes ndaj të moshuarve ose personave me aftësi të kufizuar.', 'easy', 3, true, true, 'Mos ushtroni presion me makinë.', 1);
...
'Rregulli i krahut të djathtë zbatohet në mungesë të shenjave.', 'medium', 5, true, true, 'Jepini përparësi atij që vjen nga e djathta juaj.', 2),
...
'Mjeti që ruan drejtimin e lëvizjes ka përparësi ndaj atij që pret rrugën duke u kthyer majtas.', 'hard', 8, true, true, 'Ai që kthehet majtas pret të gjithë (përveç atij përballë që kthehet majtas).', 3),
...
'Kur dilni nga zona private/parkimi, duhet t''u jepni përparësi të gjithë përdoruesve të rrugës.', 'easy', 3, true, true, 'Prisni derisa rruga të jetë plotësisht e lirë.', 1),
...
'Shigjeta e gjelbër lejon lëvizjen në atë drejtim, pavarësisht dritës kryesore.', 'medium', 5, true, true, 'Sigurohuni që këmbësorët kanë mbaruar kalimin.', 2),
...
'Mjetet me përparësi (policia, ambulanca) me sinjale të ndezura kanë përparësi ndaj të gjithëve.', 'easy', 3, true, true, 'Hapni krahun dhe ndaloni nëse është e nevojshme.', 1);
...
'Shmangni frenimin e fortë në sipërfaqe të rrëshqitshme. Ulni shpejtësinë gradualisht.', 'medium', 5, true, true, 'Mos bëni manovra të forta me timon.', 2),
...
'Aquaplaning ndodh kur uji krijon shtresë midis gomës dhe rrugës, duke humbur kontrollin.', 'hard', 8, true, true, 'Nëse ndodh, hiqni këmbën nga gazi dhe mbani timonin drejt.', 3),
...
'Dritat e gjata reflektohen në mjegull dhe ulin dukshmërinë. Përdorni të shkurtrat.', 'medium', 5, true, true, 'Rritni distancën e sigurisë.', 2),
...
'Dritat e forta mund ta ngrijnë kafshën në vend. Ulja e dritave dhe frenimi është zgjidhja më e sigurt.', 'hard', 8, true, true, 'Mos rrezikoni duke dalë nga rruga për të shmangur kafshën e vogël.', 3),
...
'Ndaloni për të shmangur dëmtimin ose aksidentin, duke kontrolluar trafikun pas jush.', 'medium', 5, true, true, 'Ndaloni në vend të sigurt dhe njoftoni autoritetet.', 2);
...
'Trotuari është për këmbësorë. Parkimi lejohet vetëm kur sinjalistika e tregon qartë.', 'easy', 3, true, true, 'Respektoni hapësirën e këmbësorëve.', 1),
...
'Nuk lejohet parkimi më afër se 5 metra nga kryqëzimi për të mos penguar pamjen.', 'hard', 8, true, true, 'Siguria e pamjes në kryqëzim është jetike.', 3),
...
'Bllokimi i hyrje-daljeve është i ndaluar.', 'easy', 3, true, true, 'Konsideroni emergjencat që mund të kenë banorët.', 1),
...
'Parkimi në rresht të dytë bllokon trafikun dhe është i ndaluar.', 'medium', 5, true, true, 'Mos u bëni pengesë për trafikun.', 2),
...
'Në dishezë, vendosni marshin indietro dhe ktheni rrotat drejt trotuarit për siguri.', 'hard', 8, true, true, 'Përdorni gjithmonë frenat e dorës.', 3);
