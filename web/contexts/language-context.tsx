...
const translations: Record<string, string> = {
    ...
    // Admin - Signs
    'admin.signs.loading': 'Duke ngarkuar shenjat...',
    'admin.signs.searchPlaceholder': 'Kërko sipas emrit ose kodit...',
    'admin.signs.allCategories': 'Të gjitha Kategoritë',
    'admin.signs.categoryDanger': 'Rreziku',
    'admin.signs.categoryProhibition': 'Ndalimi',
    'admin.signs.categoryMandatory': 'Urdhëruese',
    'admin.signs.categoryInfo': 'Lajmëruese',
    'admin.signs.changeImage': 'Ndrysho Imazhin',
    'admin.signs.name': 'Emri',
    'admin.signs.description': 'Përshkrimi',
    'admin.signs.noImage': 'Pa imazh',
    'admin.signs.edit': 'Ndrysho',
    'admin.signs.previous': 'E Mëparshme',
    'admin.signs.next': 'E Radhës',
    'admin.signs.page': 'Faqja',
    'admin.signs.of': 'nga',
    'admin.signs.deleteConfirm': 'A jeni i sigurt që doni të fshini këtë shenjë?',
    'admin.signs.imageUploaded': 'Imazhi u ngarkua me sukses',
    'admin.signs.imageUploadError': 'Dështoi ngarkimi i imazhit',
    'admin.signs.updated': 'Shenja u përditësua me sukses',
    'admin.signs.updateError': 'Dështoi përditësimi i shenjës',
    'admin.signs.deleted': 'Shenja u fshi me sukses',
    'admin.signs.deleteError': 'Dështoi fshirja e shenjës',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const [language] = useState<Language>('sq');
