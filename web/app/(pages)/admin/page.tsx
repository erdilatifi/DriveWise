...
import { FileText, Plus, BarChart3, BookOpen, Signpost } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <GlassCard hover className="h-full flex flex-col p-6 border border-border/80 bg-black/80">
              ...
              <h3 className="text-lg font-semibold mb-2">{t('admin.trafficSigns')}</h3>
              <p className="text-sm text-muted-foreground mb-4">
                {t('admin.trafficSignsDesc')}
              </p>
              <Button asChild className="w-full">
                <Link href="/admin/signs">{t('admin.manageTrafficSigns')}</Link>
              </Button>
            </GlassCard>
          </motion.div>
        </div>
