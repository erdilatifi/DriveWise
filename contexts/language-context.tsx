...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.subtitle': 'Kosovo Theory Exam',
    ...
    'dashboard.emptyChart': 'Empty',
    'dashboard.noActivity': 'No activity yet',
    'dashboard.completeTests': 'Complete tests to see your progress analytics here.',
    'dashboard.strongTopicsTitle': 'Your strongest topics',
    'dashboard.panelTitle': 'Dashboard',
    'dashboard.practiceWeakTopics': 'Practice weak topics',
    ...
    'profile.nameUpdatedTitle': 'Name updated',
    'profile.nameUpdatedDesc': 'Your display name has been updated successfully.',
    'profile.nameUpdateError': 'Could not update name.',
    'profile.accountDeletedTitle': 'Account deleted',
    'profile.accountDeletedDesc': 'Your account and all associated data have been deleted.',
    'profile.accountDeleteError': 'Could not delete account.',
    'profile.reportSubmittedTitle': 'Report submitted',
    'profile.reportSubmittedDesc': 'Thanks! Your bug report has been sent.',
    'profile.reportFailedTitle': 'Submission failed',
    'profile.activePlan': 'Active plan',
    'profile.freePlan': 'Free plan',
    'profile.noActivePlans': 'No active plans',
    'profile.startPlanDesc': 'Start a plan to unlock all premium features.',
    'profile.usage': 'Usage',
    'profile.daysLeft': 'days left',
    'profile.renewNow': 'Renew now',
    'profile.billingOneTime': 'Billing Status: One-time payment',
    'profile.noAutoRenewDesc': 'No auto-renewal. You will not be charged again automatically.',
    'profile.supportFeedback': 'Support & Feedback',
    'profile.reportBug': 'Report a bug',
    'profile.reportBugDesc': 'Found something not working correctly? Tell us and we’ll look into it.',
    
    // Admin
    'admin.searchPlaceholder': 'Search by email or name...',
    'admin.userManagement': 'User Management',
    'admin.manageUsersDesc': 'Manage registered users',
    ...
    'admin.roleUpdateError': 'Failed to update user role',
    'admin.statusUpdated': 'User status updated successfully',
    'admin.statusUpdateError': 'Failed to update user status',
    ...
    'admin.dashboardSubtitle': 'Manage questions, content, users, and subscriptions',
    'admin.allQuestions': 'All Questions',
    'admin.allQuestionsDesc': 'View and manage all quiz questions',
    'admin.viewQuestions': 'View Questions',
    'admin.users': 'Users',
    'admin.usersDesc': 'Manage registered users and roles',
    'admin.manageUsers': 'Manage Users',
    'admin.addQuestion': 'Add Question',
    'admin.addQuestionDesc': 'Create a new quiz question',
    'admin.addNew': 'Add New',
    'admin.stats': 'Statistics',
    'admin.statsDesc': 'View users, questions, and test metrics',
    'admin.viewStats': 'View Stats',
    'admin.subscriptions': 'Subscriptions',
    'admin.subscriptionsDesc': 'View and manage user plans and billing status',
    'admin.manageSubscriptions': 'Manage Subscriptions',
    'admin.decisionTrainer': 'Decision Trainer',
    'admin.decisionTrainerDesc': 'Manage Decision Trainer scenarios',
    'admin.manageScenarios': 'Manage Scenarios',
    'admin.studyMaterials': 'Study Materials',
    'admin.studyMaterialsDesc': 'Manage theory materials for each chapter',
    'admin.manageMaterials': 'Manage Materials',

    // Test Extras
    'test.loadError': 'Could not load test questions. Please try again.',
    'test.createProfileError': 'Failed to create user profile. Please try again.',
    'auth.loginAgain': 'Please log in again',
    'test.saveError': 'Failed to save test results',
    'test.saveDetailsError': 'Test saved, but details could not be stored.',
    'test.unexpectedError': 'An unexpected error occurred. Results shown locally.',
    'test.reviewTest': 'Review this test',
    'test.unlimitedTestsBenefit': 'Unlimited tests in this category',
    'test.fullReviewBenefit': 'Full review with correct answers',
    'test.trainerUnlockedBenefit': 'Decision Trainer unlocked',
    'test.upgradeCta': 'See plans',
    'test.limitReachedTitle': 'Free test limit reached',
    'test.limitReachedDescription': 'You have used your free tests for this cycle.',
    ...
    'category.noTestsDescription': 'The admin has not added mock tests for this category yet.',
    ...
    'materials.emptySubtitle': 'The admin has not added study materials for this course yet.',
    ...
    'trainer.noScenariosSubtitle': 'The admin has not added Decision Trainer scenarios yet.',
    ...
    // Rating Modal (English)
    'rating.title': 'Rate DriveWise',
    'rating.description': 'How would you rate your experience with our app?',
    'rating.selectRating': 'Please select a rating',
    'rating.success': 'Thank you for your rating!',
    'rating.error': 'Failed to submit rating',
    'rating.skip': 'Skip',
    'rating.submit': 'Submit Rating',
    'rating.submitting': 'Submitting...',
    'rating.feedback.1': "We'll work harder to improve",
    'rating.feedback.2': 'Thanks for your feedback',
    'rating.feedback.3': 'Good to know!',
    'rating.feedback.4': "Great! We're glad you like it",
    'rating.feedback.5': 'Awesome! Thank you so much!',
  },
  sq: {
    // Navigation
    'nav.home': 'Ballina',
    ...
    'dashboard.noActivity': 'Ende nuk ka aktivitet',
    'dashboard.completeTests': 'Përfundo teste për të parë analizën e progresit këtu.',
    'dashboard.strongTopicsTitle': 'Temat tua më të forta',
    'dashboard.panelTitle': 'Paneli kryesor',
    'dashboard.practiceWeakTopics': 'Ushtro pikat e dobëta',
    ...
    'profile.nameUpdatedDesc': 'Emri juaj i shfaqur u përditësua me sukses.',
    'profile.nameUpdateError': 'Nuk u arrit të përditësohej emri.',
    'profile.accountDeletedTitle': 'Llogaria u fshi',
    'profile.accountDeletedDesc': 'Llogaria juaj dhe të gjitha të dhënat e lidhura u fshinë.',
    'profile.accountDeleteError': 'Nuk u arrit të fshihej llogaria.',
    'profile.reportSubmittedTitle': 'Raporti u dërgua',
    'profile.reportSubmittedDesc': 'Faleminderit! Raporti juaj për gabimin u dërgua.',
    ...
    'profile.startPlanDesc': 'Fillo një plan për të hapur të gjitha veçoritë.',
    'profile.usage': 'Progresi',
    'profile.daysLeft': 'ditë mbetura',
    'profile.renewNow': 'Rinovoni tani',
    'profile.billingOneTime': 'Statusi i pagesës: Një herë',
    'profile.noAutoRenewDesc': 'Planet tuaja nuk kanë rinovim automatik. Nuk do të tarifoheni sërish.',
    'profile.supportFeedback': 'Mbështetje & Reagime',
    'profile.reportBug': 'Raporto një problem',
    'profile.reportBugDesc': 'Gjetët diçka që nuk punon mirë? Na tregoni dhe ne do ta rregullojmë.',

    // Admin
    'admin.searchPlaceholder': 'Kërko me email ose emër...',
    ...
    'admin.admins': 'Administratorë',
    'admin.allPlans': 'Të gjitha planet',
    'admin.premium': 'Premium',
    'admin.free': 'Falas',
    'admin.user': 'Përdoruesi',
    'admin.role': 'Roli',
    ...
    'admin.deleteUser': 'Fshij Përdoruesin',
    'admin.noUsersFound': 'Nuk u gjetën përdorues me këto kritere.',
    'admin.backToDashboard': 'Kthehu te Paneli i Adminit',
    'admin.roleUpdated': 'Roli i përdoruesit u përditësua me sukses',
    'admin.roleUpdateError': 'Dështoi përditësimi i rolit',
    'admin.statusUpdated': 'Statusi i përdoruesit u përditësua me sukses',
    ...
    'admin.deleteConfirm': 'A jeni i sigurt që doni ta fshini këtë përdorues? Ky veprim nuk mund të zhbëhet.',

    // Admin Dashboard (Albanian)
    ...
    'admin.allQuestionsDesc': 'Shiko dhe menaxho të gjitha pyetjet e kuizit',
    'admin.viewQuestions': 'Shiko Pyetjet',
    'admin.users': 'Përdoruesit',
    'admin.usersDesc': 'Menaxho përdoruesit e regjistruar dhe rolet',
    'admin.manageUsers': 'Menaxho Përdoruesit',
    'admin.addQuestion': 'Shto Pyetje',
    'admin.addQuestionDesc': 'Krijo një pyetje të re kuizi',
    'admin.addNew': 'Shto të Re',
    'admin.stats': 'Statistika',
    'admin.statsDesc': 'Shiko metrikat e përdoruesve, pyetjeve dhe testeve',
    'admin.viewStats': 'Shiko Statistikat',
    'admin.subscriptions': 'Abonimet',
    'admin.subscriptionsDesc': 'Shiko dhe menaxho planet e përdoruesve dhe statusin e pagesave',
    ...
    'admin.studyMaterials': 'Materiale Mësimore',
    'admin.studyMaterialsDesc': 'Menaxho materialet teorike për secilin kapitull',
    'admin.manageMaterials': 'Menaxho Materialet',

    // Test Extras
    'test.loadError': 'Nuk u arrit të ngarkoheshin pyetjet. Ju lutem provoni përsëri.',
    ...
    'test.saveDetailsError': 'Testi u ruajt, por detajet nuk u ruajtën.',
    'test.unexpectedError': 'Ndodhi një gabim i papritur. Rezultatet u shfaqën lokalisht.',
    'test.reviewTest': 'Rishiko këtë test',
    'test.unlimitedTestsBenefit': 'Teste të pakufizuara në këtë kategori',
    'test.fullReviewBenefit': 'Rishikim i plotë me përgjigje të sakta',
    'test.trainerUnlockedBenefit': 'Decision Trainer i hapur',
    'test.upgradeCta': 'Shiko planet',
    'test.limitReachedTitle': 'Limiti i testeve falas u arrit',
    'test.limitReachedDescription': 'Keni përdorur testet falas për këtë cikël.',
    ...
    'rating.feedback.5': 'Fantastike! Faleminderit shumë!',
  },
};
